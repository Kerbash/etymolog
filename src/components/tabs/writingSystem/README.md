...
| `RectLayoutEditor.tsx` + `rectLayoutMath.ts` | The generic draggable/resizable rectangle canvas (pointer + keyboard, snapping). Knows nothing about schemes. |
...
- `blocks/__tests__/RectLayoutEditor.test.tsx`, `rectLayoutMath.test.ts` — the canvas.
